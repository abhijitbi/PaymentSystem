...
public class RuPayRestController
{
    ...
    private static String tokenForIssuerBank=null;

    private String network="RuPay";
    ...
    public  String createSecureKey() throws Exception{                                                                  //Create Encrypted Secret Key and send it back to AcquirerBankService
        ...
        tokenAndSecurekeyRepository.save(tokenAndSecureKey);                                      //Store Token and Secure Key into the Database
        ...
        tokenForIssuerBank=getData.getDateastoken();
    ...
    private static String getTokenForIssuerBank(){
